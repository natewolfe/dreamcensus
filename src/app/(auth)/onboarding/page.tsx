  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute inset-0 opacity-50 dream-mist-layer" />
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        >
          ...
          >
            <div className="relative w-20 h-20 mx-auto">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-special-start to-special-end">
          ...
          >
            ...
            <p className="text-xs text-subtle px-4">
          ...
          {/* Privacy link */}
          <motion.button
            className="mt-8 text-sm text-muted hover:text-accent transition-colors flex items-center gap-2 mx-auto"
    ...
    <svg className="absolute inset-0 w-full h-full">
      ...
      {lines.map(([from, to], i) => {
        ...
        return (
          <motion.line
            ...
            x2={`${toStar.x}%`}
            y2={`${toStar.y}%`}
            className="stroke-constellation-edge"
            strokeWidth="1"
      ...
      {stars.map((star, i) => (
        <motion.circle
          ...
          cy={`${star.y}%`}
          r={star.size}
          className="fill-constellation-node"
