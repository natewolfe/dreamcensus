  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-60 dream-mist-layer" />
        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative flex h-8 w-8 items-center justify-center">
              <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-special-start to-special-end opacity-80 group-hover:opacity-100 transition-opacity" />
        ...
        <section className="mx-auto max-w-6xl px-6 pt-20 pb-24 md:pt-28 md:pb-32">
          <div className="max-w-3xl">
            ...
            <motion.p 
              ...
              className="text-md font-medium text-accent mb-4 tracking-wide"
            >
            ...
            >
              Capture your dreams
              <br />
              <span className="text-muted">before they fade</span>
            </motion.h1>
            ...
            <motion.div 
              ...
              className="text-lg md:text-xl text-muted leading-relaxed mb-8 mt-6 max-w-2xl"
            >
          ...
          <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
            <div className="grid gap-12 md:grid-cols-2 items-center">
              ...
              <motion.div 
                ...
                className="relative"
              >
                <div className="relative rounded-2xl border border-border bg-card-bg p-6 shadow-2xl">
                  {/* Mock morning mode screen */}
                  <div className="text-center mb-6">
                    <span className="block text-lg text-muted mb-1">Good morning</span>
                  ...
                  <div className="space-y-2 mb-6">
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-background border border-border">
                      ...
                      <div className="text-left">
                        ...
                        <span className="text-sm text-muted">Tap and speak your dream</span>
                      </div>
                    </div>
                    
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-card-bg border border-border">
                      ...
                      <div className="text-left">
                        <span className="block font-medium text-muted text-xl">Type</span>
                        <span className="text-sm text-subtle">Write at your own pace</span>
                      </div>
                    </div>
                  </div>
                  
                  <span className="block text-center text-sm text-subtle">
                    I only have a feeling →
                  </span>
                </div>
                
                {/* Decorative glow */}
                <div className="absolute -inset-4 -z-10 rounded-3xl bg-gradient-to-r from-special-start/20 via-transparent to-special-end/20 blur-2xl" />
              </motion.div>
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-border">
          <div className="w-full mx-auto max-w-6xl px-6 py-20 md:py-28 text-center">
            ...
            <motion.span 
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="block text-muted mb-8 max-w-lg mx-auto text-lg"
            >
      ...
      <footer className="border-t border-border">
        <div className="mx-auto max-w-6xl px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-subtle">
            <p>© 2026 Dream Census. All rights reserved.</p>
            <div className="flex gap-6">
              <button onClick={() => setShowPrivacyModal(true)} className="hover:text-muted transition-colors">
                Privacy
              </button>
  ...
  return (
    <div className="absolute inset-0">
      {stars.map((star, i) => (
        <motion.div
          key={i}
          className="absolute rounded-full bg-constellation-node"
          style={{
            left: `${star.x}%`,
            top: `${star.y}%`,
            width: star.size,
...
function FeatureCard({ 
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
      transition={{ delay }}
      className="group relative p-6 rounded-2xl bg-card-bg border border-border hover:border-subtle transition-colors"
    >
      <div 
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="How Your Data Stays Safe">
      <div className="space-y-6">
        ...
        <div className="flex gap-4">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-special-start/20">
            <svg className="w-5 h-5 text-special-start" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
