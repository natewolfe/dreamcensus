...
export default function OnboardingSetupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#040508] text-[#e8eaf6] flex flex-col">
      {/* Background effects */}
      <div className="fixed inset-0 pointer-events-none">
        <div 
          className="absolute inset-0 opacity-40"
          style={{
            background: 'radial-gradient(ellipse at 50% 20%, rgba(149, 117, 205, 0.15) 0%, transparent 60%)',
          }}
        />
      </div>
        ...
        <div className="relative z-10 px-6 pt-4">
          <div className="max-w-2xl mx-auto">
            <div className="h-1 bg-[#1a1c2e] rounded-full overflow-hidden">
              <motion.div 
                className="h-full bg-gradient-to-r from-[#9575cd] to-[#b093ff] rounded-full"
                initial={{ width: 0 }}
                animate={{ width: `${progress}%` }}
                transition={{ duration: 0.3 }}
              />
            </div>
            <p className="text-xs text-[#5c6bc0] mt-2">
  ...
  return (
    <Card className="bg-[#0c0e1a]/80 backdrop-blur-sm border-[#262942]" padding="lg">
      <div className="mb-8 text-center">
        ...
        <p className="text-[#7986cb]">You can change these anytime in settings</p>
      </div>

      <div className="space-y-3 mb-8">
        {/* Base tier - always on */}
        <div className="rounded-xl border border-[#262942] p-4 bg-[#13152a]/50">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#b093ff]/15">
                <span className="text-xl">🔒</span>
              </div>
              <div>
                <h3 className="font-semibold">Private Journal</h3>
                <p className="text-sm text-[#7986cb]">
                  Your dreams, encrypted and yours alone
                </p>
              </div>
            </div>
            <span className="text-xs text-[#b093ff] font-medium px-2 py-1 rounded-full bg-[#b093ff]/10">
              Always on
            </span>
          </div>
        </div>
        ...
        <button
          ...
          className={`w-full rounded-xl border p-4 text-left transition-all duration-200 ${
            selections.insights
              ? 'border-[#b093ff]/50 bg-[#b093ff]/5'
              : 'border-[#262942] bg-[#13152a]/50 hover:border-[#3f4774]'
          }`}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className={`flex h-11 w-11 items-center justify-center rounded-xl transition-colors ${
                selections.insights ? 'bg-[#b093ff]/20' : 'bg-[#3f4774]/30'
              }`}>
                <span className="text-xl">✨</span>
              </div>
              <div>
        ...
        <button
          ...
          className={`w-full rounded-xl border p-4 text-left transition-all duration-200 ${
            !selections.insights
              ? 'border-[#262942] bg-[#0c0e1a]/50 opacity-50 cursor-not-allowed'
              : selections.commons
                ? 'border-[#b093ff]/50 bg-[#b093ff]/5'
                : 'border-[#262942] bg-[#13152a]/50 hover:border-[#3f4774]'
          }`}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className={`flex h-11 w-11 items-center justify-center rounded-xl transition-colors ${
                selections.commons ? 'bg-[#b093ff]/20' : 'bg-[#3f4774]/30'
              }`}>
                <span className="text-xl">🌍</span>
              </div>
              <div>
                ...
                {!selections.insights && (
                  <p className="text-xs text-[#b093ff] mt-1">
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className={`flex h-11 w-11 items-center justify-center rounded-xl transition-colors ${
                selections.studies ? 'bg-[#b093ff]/20' : 'bg-[#3f4774]/30'
              }`}>
                <span className="text-xl">🔬</span>
              </div>
              <div>
...
function RhythmScreen({
  ...
  return (
    <Card className="bg-[#0c0e1a]/80 backdrop-blur-sm border-[#262942]" padding="lg">
      <button
        onClick={onBack}
        className="mb-6 flex items-center gap-2 text-sm text-[#7986cb] hover:text-[#e8eaf6] transition-colors"
      >
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-[#7986cb]">We'll adapt the app to your sleep schedule</p>
      </div>
      ...
      <div className="space-y-8 mb-8">
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                  settings.bedtime === time
                    ? 'bg-[#b093ff] text-[#040508]'
                    : 'bg-[#13152a] border border-[#262942] hover:border-[#3f4774] text-[#9fa8da]'
                }`}
              >
                {formatTime(time)}
              </button>
        ...
        {/* Reminders */}
        <div className="border-t border-[#262942] pt-6">
          <h3 className="text-center text-lg mb-4">Reminders</h3>
          <div className="space-y-2">
            <label className="flex items-center gap-4 p-4 rounded-xl bg-[#13152a]/50 cursor-pointer hover:bg-[#13152a] transition-colors border border-transparent hover:border-[#262942]">
              <input
                type="checkbox"
                ...
                className="w-5 h-5 rounded border-[#3f4774] bg-[#0c0e1a] accent-[#b093ff]"
              />
              <div>
                <p className="font-medium">Pre-sleep check-in</p>
                <p className="text-xs text-[#7986cb]">30 min before bed</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-4 p-4 rounded-xl bg-[#13152a]/50 cursor-pointer hover:bg-[#13152a] transition-colors border border-transparent hover:border-[#262942]">
              ...
              <div>
                ...
                <p className="text-xs text-[#7986cb]">At wake time</p>
              </div>
            </label>
          </div>
        </div>
  ...
  return (
    <Card className="bg-[#0c0e1a]/80 backdrop-blur-sm border-[#262942]" padding="lg">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-[#7986cb]">What would you like to do first?</p>
      </div>

      <div className="space-y-3 mb-6">
        <button
          onClick={() => onComplete('morning')}
          className="w-full rounded-xl border border-[#262942] p-5 text-left hover:border-[#b093ff]/50 hover:bg-[#b093ff]/5 transition-all duration-200 group"
        >
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#d4a574]/15 group-hover:bg-[#d4a574]/25 transition-colors">
              <span className="text-2xl">🌅</span>
            </div>
            <div className="flex-1">
              <h3 className="font-semibold mb-0.5">Try Morning Capture</h3>
              <p className="text-sm text-[#7986cb]">See how dream logging works</p>
            </div>
            <span className="text-xs text-[#b093ff] bg-[#b093ff]/10 px-2 py-1 rounded-full">~30s</span>
          </div>
        </button>
        ...
        >
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#7ec8c8]/15 group-hover:bg-[#7ec8c8]/25 transition-colors">
              <span className="text-2xl">📋</span>
            </div>
            <div className="flex-1">
              <h3 className="font-semibold mb-0.5">Start the Census</h3>
              <p className="text-sm text-[#7986cb]">Tell us about your sleep patterns</p>
            </div>
            <span className="text-xs text-[#b093ff] bg-[#b093ff]/10 px-2 py-1 rounded-full">~3min</span>
          </div>
        </button>
        ...
        >
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#b093ff]/15 group-hover:bg-[#b093ff]/25 transition-colors">
              <span className="text-2xl">💭</span>
            </div>
            <div className="flex-1">
              <h3 className="font-semibold mb-0.5">Explore Prompts</h3>
              <p className="text-sm text-[#7986cb]">Browse reflection questions</p>
            </div>
            <span className="text-xs text-[#5c6bc0] bg-[#3f4774]/30 px-2 py-1 rounded-full">No limit</span>
          </div>
        </button>
      </div>
      ...
      <button
        ...
        className="w-full text-center text-sm text-[#7986cb] hover:text-[#b093ff] transition-colors py-2"
      >
        Skip to Today →
      </button>
    </Card>
      ...
      <div className="relative mb-8 h-40 w-40 mx-auto">
        ...
        {[...Array(7)].map((_, i) => {
          ...
          return (
            <motion.div
              key={i}
              className="absolute w-2 h-2 bg-[#b093ff] rounded-full"
              style={{
                left: '50%',
                top: '50%',
              }}
