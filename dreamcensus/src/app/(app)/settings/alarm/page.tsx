...
import { Card, Switch, TimePicker, PageHeaderSkeleton, Skeleton } from '@/components/ui'
...
import { getScheduleRepeatLabel } from '@/lib/alarm'
import {
  getAlarmSettings,
  updateAlarmSchedule,
  setAlarmArmed,
  ...
  return (
    <div id="main-content" className="container mx-auto max-w-2xl px-4 py-8 pb-16">
      ...
      <div className="space-y-6 mt-6">
        ...
        <Card padding="lg" className="mb-3">
          <div className="flex flex-col gap-3">
            <span className="text-md text-muted font-medium">
              Repeats <span className="font-bold text-accent">{getScheduleRepeatLabel(schedule)}</span>
            </span>
            <AlarmScheduleEditor
              schedule={schedule}
